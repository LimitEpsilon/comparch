...
class Control extends Module {
  ...
  val signals =
    ListLookup(io.opcode,
      ...
      BitPat("b0000011") -> List(false.B, true.B,  1.U,   true.B,  false.B,  true.B,  true.B,     0.U,    0.U),//load
      // S-format
      BitPat("b0100011") -> List(false.B, false.B, 0.U,   true.B,  true.B,   true.B,  false.B,    0.U,    0.U),
      // B-format
      BitPat("b1100011") -> List(true.B,  false.B, 0.U,   true.B,  false.B,  true.B,  false.B,    1.U,    0.U),
      // U-format
      BitPat("b0110111") -> List(false.B, false.B, 0.U,   true.B,  false.B,  true.B,  true.B,     1.U,    0.U),//LUI
      BitPat("b0010111") -> List(false.B, false.B, 0.U,   true.B,  false.B,  true.B,  true.B,     2.U,    0.U),//AUIPC
      // J-format
      BitPat("b1101111") -> List(false.B, false.B, 2.U,   true.B,  false.B,  true.B,  true.B,     2.U,    2.U),//JAL
      BitPat("b1100111") -> List(false.B, false.B, 2.U,   true.B,  false.B,  true.B,  true.B,     0.U,    3.U),//JALR
      ) // Array
    ) // ListLookup
